            ...
            <div className="col-md-4 d-flex justify-content-center justify-content-md-end align-items-center">
              <div className="d-flex">
                ...
                <div className="dropdown togglech ">
                  ...
                  <ul className="dropdown-menu dropdown-menu-end togglec " aria-labelledby="navbarDropdownMenuLink">
              ...
              {props.isLogin===true?<div className="dropdown togglech">
                ...
                <>
                  ...
                  <Link className='textc' to='/login'>Login</Link>
                </div>
                <div className="dropdown ">
                  <Link className='textc' to='/register'>Register</Link>
                </div></>
                }
