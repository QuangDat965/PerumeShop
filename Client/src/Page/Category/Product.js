    ...
    return (
        ...
        <div className="container">
            <div className="row">
                {products.map((e, i) => {
                    return (
                        <div className="col-lg-3 col-sm-4 col-11 offset-sm-0 offset-10  col-md-4 mb-3">
                            <div className="card">
                                ...
                                <div className="card-body bg-light text-center">
                                    <div className="mb-2">
                                        <h6 className="font-weight-semibold mb-2">
                                            <a href="#" className="text-default mb-2" data-abc="true">{e.title}</a>
                                        </h6>
                                        <a href="#" className="text-muted" data-abc="true">{e.desc}</a>
                                    </div>
